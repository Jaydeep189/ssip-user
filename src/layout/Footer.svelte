		...
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
			<div>
				<div class="flex justify-center sm:justify-start items-center gap-3">
					<img src="amc_logo.jpg" class="h-20" alt="" />
					<h1 class="font-bold text-5xl">AMC</h1>
				</div>

				<p
					class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:mx-0 sm:max-w-xs sm:text-left"
				>
					The Amdavad Municipal Corporation, or the AMC, established in July 1950 under the Bombay
					Provincial Corporation Act, is responsible for the civic infrastructure and administration
					...
					<ul class="mt-8 space-y-4 text-sm">
						<li>
							<a class="flex items-center justify-center gap-1.5 sm:justify-start" href="/">
								...
								<span class="text-gray-700">admin@ahmedabadcity.gov.in</span>
							</a>
						</li>
						...
						<li>
							<a class="flex items-center justify-center gap-1.5 sm:justify-start" href="/">
								...
								<span class="text-gray-700">07925391811</span>
							</a>
						</li>
						...
						<li class="flex items-start justify-center gap-1.5 sm:justify-start">
							...
							<address class="-mt-0.5 not-italic text-gray-700">
								2H55+F4M, Vikas Gruh Rd, Fatehpura Gam, Paldi, Ahmedabad, Gujarat 380007
							</address>
						</li>
					</ul>
				</div>
		...
		<div class="mt-12 border-t border-gray-100 pt-6">
			<div class="text-center sm:flex sm:justify-between sm:text-left">
				...
				<p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
					&copy; 2022 The Amdavad Municipal Corporation
				</p>
			</div>
		</div>
	</div>
